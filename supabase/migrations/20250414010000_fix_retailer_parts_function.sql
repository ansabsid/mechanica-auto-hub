...
-- Drop and recreate the function to get retailer parts that a garage can offer installation for
DROP FUNCTION IF EXISTS public.get_retailer_parts_for_garage;
