...
const EditProductModal: React.FC<EditProductModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md md:max-w-2xl max-h-[90vh] flex flex-col p-0 overflow-hidden">
          ...
          <ScrollArea className="h-[calc(80vh-10rem)]">
            <div className="px-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                ...
                {/* Add extra bottom padding to ensure form content doesn't get hidden behind fixed footer */}
                <div className="h-20 col-span-full"></div>
              </div>
            </div>
          </ScrollArea>
        </div>
