        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="hover:shadow-md transition-all transform hover:-translate-y-1 cursor-pointer">
            <CardContent className="pt-6 flex flex-col items-center">
              <div className="w-20 h-20 rounded-full bg-mechanica-200 mb-4 flex items-center justify-center text-mechanica-600 font-bold text-lg relative overflow-hidden hover:scale-110 transition-transform">
                <div className="absolute inset-0 bg-gradient-to-br from-mechanica-100 to-mechanica-300"></div>
                <span className="relative">CEO</span>
              </div>
          ...
          <Card className="hover:shadow-md transition-all transform hover:-translate-y-1 cursor-pointer">
            <CardContent className="pt-6 flex flex-col items-center">
              <div className="w-20 h-20 rounded-full bg-mechanica-200 mb-4 flex items-center justify-center text-mechanica-600 font-bold text-lg relative overflow-hidden hover:scale-110 transition-transform">
                <div className="absolute inset-0 bg-gradient-to-br from-mechanica-100 to-mechanica-300"></div>
                <span className="relative">CTO</span>
              </div>
          ...
          <Card className="hover:shadow-md transition-all transform hover:-translate-y-1 cursor-pointer">
            <CardContent className="pt-6 flex flex-col items-center">
              <div className="w-20 h-20 rounded-full bg-mechanica-200 mb-4 flex items-center justify-center text-mechanica-600 font-bold text-lg relative overflow-hidden hover:scale-110 transition-transform">
                <div className="absolute inset-0 bg-gradient-to-br from-mechanica-100 to-mechanica-300"></div>
                <span className="relative">COO</span>
              </div>
          ...
          <Card className="hover:shadow-md transition-all transform hover:-translate-y-1 cursor-pointer">
            <CardContent className="pt-6 flex flex-col items-center">
              <div className="w-20 h-20 rounded-full bg-mechanica-200 mb-4 flex items-center justify-center text-mechanica-600 font-bold text-lg relative overflow-hidden hover:scale-110 transition-transform">
                <div className="absolute inset-0 bg-gradient-to-br from-mechanica-100 to-mechanica-300"></div>
                <span className="relative">CMO</span>
              </div>
              ...
              <div className="flex space-x-2 mt-2">
                ...
                <div className="bg-blue-100 rounded-full w-5 h-5 flex items-center justify-center">
                  <span className="text-blue-600 text-xs">f</span>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      content: (
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="animate-bounce">
            <Rocket size={100} className="text-mechanica-500" />
          </div>
          
          <h2 className="text-3xl font-bold text-center animate-fade-in">BookMyParts</h2>
          <p className="text-center text-lg animate-fade-in" style={{animationDelay: "0.3s"}}>
            Connecting car owners with parts and trusted garages
          </p>
          <p className="text-center text-mechanica-600 font-semibold animate-fade-in" style={{animationDelay: "0.6s"}}>
            Contact: info@bookmyparts.com
          </p>
          
          <div className="mt-6 flex space-x-4 animate-fade-in" style={{animationDelay: "0.9s"}}>
            <Button variant="outline" className="rounded-full hover:bg-mechanica-100 hover:text-mechanica-600 transition-all">
              Website
            </Button>
            <Button variant="outline" className="rounded-full hover:bg-mechanica-100 hover:text-mechanica-600 transition-all">
              Demo
            </Button>
            <Button variant="default" className="rounded-full bg-mechanica-500 hover:bg-mechanica-600 transition-all">
              Invest Now
            </Button>
          </div>
        </div>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className={`flex-grow flex flex-col ${slides[currentSlide].bgColor} transition-colors duration-500`}>
        ...
        <header className="p-4 sm:p-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-center text-mechanica-600 transition-all duration-300 hover:scale-105">
        ...
        <main className="flex-grow flex items-center justify-center p-6">
          <div 
            className={`w-full max-w-md mx-auto transition-all duration-300 transform ${getSlideAnimationClass()} flex flex-col items-center justify-center`}
          >
        ...
        <footer className="p-4 flex justify-between items-center">
          <Button
            ...
            className="transition-all duration-200 hover:bg-mechanica-50 hover:scale-105"
          >
            ...
            {slides.map((_, index) => (
              <div 
                ...
                className={`w-2 h-2 rounded-full transition-all cursor-pointer ${
                  currentSlide === index ? 'bg-mechanica-500 scale-125' : 'bg-gray-300 hover:bg-gray-400'
                }`}
                onClick={() => {
