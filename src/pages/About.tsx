        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-subtle">
              <div className="bg-mechanica-100 p-4 rounded-full inline-flex mb-6">
                <User className="h-8 w-8 text-mechanica-600" />
              </div>
              <h3 className="text-xl font-semibold mb-3">For Car Owners</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-subtle">
              <div className="bg-mechanica-100 p-4 rounded-full inline-flex mb-6">
                <Wrench className="h-8 w-8 text-mechanica-600" />
              </div>
              <h3 className="text-xl font-semibold mb-3">For Garages</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-subtle">
              <div className="bg-mechanica-100 p-4 rounded-full inline-flex mb-6">
                <Globe className="h-8 w-8 text-mechanica-600" />
              </div>
              <h3 className="text-xl font-semibold mb-3">For the Industry</h3>
              <p className="text-gray-600">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex space-x-4">
              <div className="bg-mechanica-100 p-3 h-12 w-12 rounded-full flex-shrink-0 flex items-center justify-center">
                <Award className="h-6 w-6 text-mechanica-600" />
              </div>
              <div>
            ...
            <div className="flex space-x-4">
              <div className="bg-mechanica-100 p-3 h-12 w-12 rounded-full flex-shrink-0 flex items-center justify-center">
                <ThumbsUp className="h-6 w-6 text-mechanica-600" />
              </div>
              <div>
